...
*          *indMin_len 数组长度
*/
void findPeaks(float *src, int src_lenth, int *indMax, int *indMax_len, U16 distance, F32 lowbound, F32 upbound)
{
...
void findVallies(float *src, int src_lenth, int *indMin, int *indMin_len, U16 distance, F32 lowbound, F32 upbound)
{
    int *sign = (int *)malloc(src_lenth * sizeof(int));
    S16 max_index = 0,
        min_index = 0;
...
void findNearzeros(float *src, int len, int *nz, int *resize,
